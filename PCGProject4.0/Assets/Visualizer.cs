...
public class Visualizer : MonoBehaviour {
    ...
    public static void extrude(State state, int height = 10, Vector2[] uvs = null, int[] triangles = null, Vector3[] normals = null) {
    ...
    public static void scale(State state, float x = 1, float y = 1, float z = 1) {
    ...
    public static void translate(State state, float x = 0, float y = 0, float z = 0) {
