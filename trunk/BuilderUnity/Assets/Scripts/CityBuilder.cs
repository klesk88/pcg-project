...
public class CityBuilder : MonoBehaviour{
	...
	void Start(){
        Vector3[] exampleVertices = new Vector3[4];
        exampleVertices[0].x = -2; exampleVertices[0].y = 0; exampleVertices[0].z = -2;
        exampleVertices[1].x = -2; exampleVertices[1].y = 0; exampleVertices[1].z = 2;
        exampleVertices[2].x = 2; exampleVertices[2].y = 0; exampleVertices[2].z = 2;
        exampleVertices[3].x = 2; exampleVertices[3].y = 0; exampleVertices[3].z = -2;
        addBuilding(exampleVertices, 2);
	}
